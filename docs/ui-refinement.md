...
- Map / List are the two top-level views. Map results expand from the bottom count/coverage bar. 2D / Globe controls belong to the map’s top-right corner. Redundant Results, Accessible list and Northern Europe buttons are removed.
