...
public sealed record WorkspaceDto(string Id, string Name, long Revision, int SchemaVersion,
    PaneDto[] Panes, LinkGroupDto[] LinkGroups, Dictionary<string, object?> AppStates,
    DateTimeOffset CreatedAt, DateTimeOffset UpdatedAt);
public sealed record WorkspaceSummaryDto(string Id, string Name, long Revision, DateTimeOffset UpdatedAt);
