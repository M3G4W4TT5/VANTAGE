...
namespace Vantage.Api.Persistence.Migrations
{
    ...
    [Migration("20260923171048_GeoJsonFeatures")]
    partial class GeoJsonFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vantage.Api.Platform.Observations.CurrentGeoJsonRow", b =>
                {
                    b.Property<string>("ConnectionId")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
                    ...
                    b.HasIndex("ConnectionId", "InLatestFeed", "SourceTime");

                    b.ToTable("current_geojson", "platform");
                });
            ...
            modelBuilder.Entity("Vantage.Api.Platform.Observations.GeoJsonFeedRow", b =>
                {
                    b.Property<string>("ConnectionId")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
                    ...
                    b.ToTable("geojson_feeds", "platform");
                });
