...
export const categoryOf = (domain: AtlasLayer['domain']) => domain === 'aircraft' ? 'Vehicles & satellites' : 'Events & alerts';
export const domainLabel = (domain: AtlasLayer['domain']) => domain === 'aircraft' ? 'Aircraft' : 'Earthquakes';
